(function() {
    ...
    L.TileLayer.Batch = L.TileLayer.extend({
        ...
        getTileUrl: function(coords) {
            return `/tiles?world=${this._worldName}&zoom=0&x=${coords.x}&z=${coords.y}`;
        },
    ...
    function updateTileLayer() {
        ...
        // Note: URL template is overridden by getTileUrl() to use query params
        tileLayer = L.tileLayer.batch('/tiles', {
            tileSize: TILE_SIZE,
            minNativeZoom: 0,
            maxNativeZoom: 0,
            minZoom: -4,
